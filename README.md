...
A real-time, multi-agent AI News Hub powered by **LangGraph**, **FastAPI**, and **React (Vite)**. The platform orchestrates 23 specialized AI category agents to scrape, process, and summarize the latest news headlines.

---

## 🚀 About the Project

This system organizes autonomous AI agents that fetch and analyze news across 23 distinct technical domains (such as Machine Learning, Large Language Models, MLOps, AI Ethics, Computer Vision, and RAG). 
